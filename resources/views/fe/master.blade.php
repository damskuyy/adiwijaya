...
<head>
    ...
    <link href="https://use.fontawesome.com/releases/v5.15.4/css/all.css" integrity="sha384-jLKHWMZtZqq8eR+MjD3+fFF+AHMPYiq/5qz2+Y7DhF9Y5yKt7A1R2v3SxZ1l8x6f" crossorigin="anonymous" rel="stylesheet" >
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.4/css/all.css" integrity="sha384-jLKHWMZtZqq8eR+MjD3+fFF+AHMPYiq/5qz2+Y7DhF9Y5yKt7A1R2v3SxZ1l8x6f" crossorigin="anonymous">
        ...
        <div class="row gx-0">
            ...
            <div class="col-lg-4 text-center text-lg-end">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    ...
                    <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="https://www.tiktok.com/@adiwijaya.teknik3" target="_blank"><i class="fab fa-tiktok fw-normal"></i></a>
                    <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="https://www.facebook.com/adiwijaya.teknik/" target="_blank"><i class="fab fa-facebook-f fw-normal"></i></a>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Profil Perusahan PT. Adiwijaya Mega Tama</h1>
                    </div>
                    <p class="mb-4">PT. Adiwijaya Mega Tama bergerak dibidang pengerjaan logam khususnya Machining, Fabrikasi, dan Konstruksi pembuatan dan reparasi komponen mesin industri.</p>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <a href="https://maps.app.goo.gl/hPiJ73FECVgnbJqFA" target="_blank" class="mb-0 text-light">Jl. Pahlawan No. 262 Sanja - Bogor</a>
                            </div>
                            <div class="d-flex mb-2">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <a class="mb-0 text-light" href="https://wa.me/6285643992099" target="_blank">+62 856-4399-2099</a>
                            </div>
                            <div class="d-flex mt-4">
                                <a class="btn btn-primary btn-square me-2" href="https://www.instagram.com/adiwijaya.teknik/" target="_blank"><i class="fab fa-instagram fw-normal"></i></a>
                                <a class="btn btn-primary btn-square me-2" href="https://www.tokopedia.com/adiwijayateknik" target="_blank"><i class="fas fa-shopping-cart"></i></a>
                                <a class="btn btn-primary btn-square me-2" href="https://www.tiktok.com/@adiwijaya.teknik3" target="_blank"><i class="fab fa-tiktok fw-normal"></i></a>
                                <a class="btn btn-primary btn-square" href="https://www.facebook.com/adiwijaya.teknik/" target="_blank"><i class="fab fa-facebook-f fw-normal"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5 ms-lg-4">
                            <div class="section-title section-title-sm position-relative pb-3 mb-4">
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">PT. Adiwijaya Megatama</a>. All Rights Reserved. 
